...
class JiTBlock(nn.Module):
    ...
    @torch.compile
    def forward(self, x, context, feat_rope=None):
...
class JiT(nn.Module):
    ...
    def forward(self, x, cond):
        ...
        for i, block in enumerate(self.blocks):
            ...
            x = block(x, context, self.feat_rope if i < self.in_context_start else self.feat_rope_incontext)
